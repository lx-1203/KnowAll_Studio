...
import { BulbOutlined, MenuOutlined, LogoutOutlined, BookOutlined, ReadOutlined } from '@ant-design/icons'
...
export default function App() {
  ...
  const menuItems = [
    { key: '/', icon: <DashboardIcon />, label: <Link to="/">学习仪表盘</Link> },
    { type: 'group', label: '学习中心', children: [
      { key: '/quiz', icon: <QuizIcon />, label: <Link to="/quiz">题库练习</Link> },
    ...
    { type: 'group', label: '个人设置', children: [
      { key: '/personal', icon: <UserIcon />, label: <Link to="/personal">个人中心</Link> },
      { key: '/share', icon: <ShareIcon />, label: <Link to="/share">协作分享</Link> },
      { key: '/settings', icon: <SettingsIcon />, label: <Link to="/settings">系统设置</Link> },
    ]},
  ]
