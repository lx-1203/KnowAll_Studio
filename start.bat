...
echo.
if !RETRY! EQU 1 (
    echo   [Attempt 1/3] Default PyPI (300s timeout) ...
...
echo.
start "KnowAll-Backend" /D "%~dp0backend" cmd /k "set HF_ENDPOINT=https://hf-mirror.com && python -m uvicorn app.main:app --host 127.0.0.1 --port 8001 --reload --reload-dir app"
